...
```
PUP-v1.0.html   # Main entry point and UI markup
...
Open `PUP-v1.0.html` in any modern browser. No build step or server required — all dependencies are loaded from CDN.
