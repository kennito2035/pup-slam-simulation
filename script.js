...
function animate() {
    ...
    if (isPlaying) {
        ...
        // Fix 3: Rotational Wobble added for realism
        ...
        scanners.forEach(s => {
            ...
            for (let j = 0; j < subSteps; j++) {
                ...
                for (let i = 0; i < NUM_POINTS; i++) {
                    ...
                    // Quick broad-phase rejection bounding box
                    if (Math.abs(dx) > RANGE_MAX || Math.abs(dy) > RANGE_MAX || Math.abs(dz) > RANGE_MAX) continue;
